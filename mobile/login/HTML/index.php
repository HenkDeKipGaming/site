...
<html lang="nl">
    ...
    <head>
        <!-- Title -->
        <title>MinetopiaATM - Index</title>
        <!-- Meta -->
                    ...
                    <div class="col-md-12 no-padding">
                        <div class="text-center visible-lg">
                            <ul id="hornavmenu" class="nav navbar-nav">
                                ...
                                <li>
                                    <span class="fa-gears">PLUGINS</span>
                                    <ul>
                                        <li>
                                            <a href="MinetopiaATM.php">MinetopiaATM</a>
                                        </li>
                                        <li>
                                            <a href="MinetopiaATM_premium.php">MinetopiaATM - Premium</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
